...
# possible_cell and i are two pointers
# row[possible_cell] is a POSSIBLE empty cell, bu not necessarily true. It is on the left of a certainly not available cell (obstacle or dropped stone)
